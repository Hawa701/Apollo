...
function validateForm() {
  ...
  fnameInput.value == ""
    ? (fnameAlert.style.display = "flex")
    : (fnameAlert.style.display = "none");
  lnameInput.value == ""
    ? (lnameAlert.style.display = "flex")
  ...
  confirmPasswordInput.value == ""
    ? (confirmPasswordAlert.style.display = "flex")
    : (confirmPasswordAlert.style.display = "none");
  !agreeCheckbox.checked
    ? (agreeeAlert.style.display = "flex")
    : (agreeeAlert.style.display = "none");
