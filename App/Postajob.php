  ...
  <div class="wrapper">  <?php include('header.php');
    ...
    <section class="section">
      <div class="Postajob-wrap">
        ...
        <?php }  ?>
        <form action="PostajobFormValidate.php" class="Postajob-form" method="POST">
          <!-- title -->
          <label for="job-title">Job Title </label>
          <div class="display">
            <input  type="text" id="job-title" name='title' value="<?php if(!empty($_GET['Title'])){echo  $_GET['Title'];}  ?>" />
          ...
          <div class="display">
            <input  type="text" id="job-position" name="position" value="<?php if(!empty($_GET['pos'])){echo  $_GET['pos'];}  ?>" />
          ...
          <div class="display">
            <textarea  id="job-desc" name='decscription' ><?php if(!empty($_GET['Des'])){echo  $_GET['Des'];}  ?> </textarea>
          ...
          <div class="display">
            <input  type="text" id="job-payment" name='payment' value="<?php if(!empty($_GET['Pay'])){echo  $_GET['Pay'];}  ?>"/>
          ...
          <div class="display">
            <input  type="text" id="job-tokens" name='tokens' value="<?php if(!empty($_GET['tokens'])){echo  $_GET['tokens'];}  ?>"/>
