...
if (
  ...
  if (
    ...
    $sql =     $sql = "INSERT INTO job (  `Job_ID`, `Job_Title`, `Job_Position`, `Description`, `Payment`, `Experience`, `Date`, `Proposals`, `Token`, `Employment`, `Profile_ID`, `Estimated_Time`, `Status`) 
                                  VALUES ( NULL,'$Title', '$Position', '$Description', '$Payment', '$Experience', '$CurrDate', 0, '$Tokens', '$Employment', $profile_ID,'$Estimated_date', 'Interviewing')";
    ...
    if ($result) {
      ...
      echo "<script>
          alert(\"Job is registered succesfully!\")
        </script>";
    } else {
      echo "<script>
